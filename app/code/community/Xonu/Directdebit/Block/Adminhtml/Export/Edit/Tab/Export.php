 ...
 *
 */
class Xonu_Directdebit_Block_Adminhtml_Export_Edit_Tab_Export extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    {
        if (Mage::getSingleton('admin/session')->isAllowed('system/convert/xonu_directdebit/export')) {
            if(Mage::getStoreConfigFlag('xonu_directdebit/export/format_xml'))
                $this->addExportType('*/*/xml', $this->_helper()->__('XML'));

            if(Mage::getStoreConfigFlag('xonu_directdebit/export/format_csv'))
                $this->addExportType('*/*/csv', $this->_helper()->__('CSV'));

            if(Mage::getStoreConfigFlag('xonu_directdebit/export/format_dta'))
                $this->addExportType('*/*/dta', $this->_helper()->__('DTA'));
        }
    ...
    {
        if (Mage::getSingleton('admin/session')->isAllowed('admin/system/convert/xonu_directdebit/export'))
        {
