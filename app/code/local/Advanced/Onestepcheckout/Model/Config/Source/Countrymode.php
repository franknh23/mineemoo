...
class Advanced_Onestepcheckout_Model_Config_Source_Countrymode{
    ...
    {
        return array(
            array('value' => 0, 'label'=>Mage::helper('onestepcheckout')->__('With VAT')),
            array('value' => 1, 'label'=>Mage::helper('onestepcheckout')->__('Without VAT if VAT Number is Verified')),
            array('value' => 2, 'label'=>Mage::helper('onestepcheckout')->__('Without VAT')),
