 ...
 */
class Advanced_Delivery_Model_Mysql4_Intervals_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {

    public function _construct() {
        parent::_construct();
        $this->_init('delivery/intervals');
    }
    ...
    public function addStoreFilter($store, $withAdmin = true) {
        ...
        $this->addFilter('store', array('in' => $store));
