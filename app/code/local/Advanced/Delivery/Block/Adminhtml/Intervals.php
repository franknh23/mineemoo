 ...
 */
class Advanced_Delivery_Block_Adminhtml_Intervals extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_intervals';
        $this->_blockGroup = 'delivery';
        $this->_headerText = Mage::helper('delivery')->__('Manager Time Interval ');
        $this->_addButtonLabel = Mage::helper('delivery')->__('Add Time Intervals');
        parent::__construct();
    }
}