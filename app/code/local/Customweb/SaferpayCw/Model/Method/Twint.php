...
class Customweb_SaferpayCw_Model_Method_Twint extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_twint';
	protected $paymentMethodName = 'twint';
