...
class Customweb_SaferpayCw_Model_Method_ApplePay extends Customweb_SaferpayCw_Model_Method
{
	protected $_code = 'saferpaycw_applepay';
	protected $paymentMethodName = 'applepay';
