 ...
 */
class Customweb_SaferpayCw_Model_TransactionCleanUpCron {
	...
	public function cleanUp() {
		...
		$failedCollection = Mage::getModel('saferpaycw/transaction')->getCollection()
		...
		$pendingCollection = Mage::getModel('saferpaycw/transaction')->getCollection()
		...
		$noStatusCollection = Mage::getModel('saferpaycw/transaction')->getCollection()
