...
class Customweb_SaferpayCw_ConfigsaferpaycwController extends Mage_Adminhtml_Controller_Action {
	...
	protected function _isAllowed(){
		return Mage::getSingleton('admin/session')->isAllowed('system/saferpaycw');
	}
	...
	public function viewAction(){
		...
		if (!empty($machineName)) {
			...
			$this->_addContent($this->getLayout()->createBlock('saferpaycw/adminhtml_backendForm_form')->setForm($form));
		}
