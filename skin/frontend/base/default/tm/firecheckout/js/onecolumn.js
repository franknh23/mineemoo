...
document.observe('dom:loaded', function() {
    ...
    if (typeof checkout !== 'undefined') {
        checkout.gotoSection = checkout.gotoSection.wrap(function (o, section) {
            var step = FC.gotoMapping[section];
            if (step) {
...
document.observe('firecheckout:setLoadWaitingBefore', function(e) {
    if (!OnecolumnCheckout.currentStep) {
        return;
    }
...
document.observe('firecheckout:setResponseAfter', function(e) {
    ...
    if (e.memo.response.onecolumn_step) {
        ...
        step = FC.gotoMapping[e.memo.response.goto_section];
    }
