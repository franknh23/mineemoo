...
class Sepa_DirectDebit extends Sepa_Base {
     ...
     */
    const SeqTp_FirstRecurrent = 'FRST';
    const SeqTp_Recurrent      = 'RCUR';
    const SeqTp_OneTime        = 'OOFF';
    const SeqTp_LastRecurrent  = 'FNAL';
    private $_sequenceType     = self::SeqTp_OneTime;
    private $_validSequenceTypes = array(
        self::SeqTp_FirstRecurrent,
        self::SeqTp_Recurrent,
        self::SeqTp_OneTime,
        self::SeqTp_LastRecurrent
    );

    /**
     * PAIN008 format version:
     * pain.008.001.02
     * pain.008.002.02
     * pain.008.003.02
     * @var string
     */
    private $_painFormat  = 'pain.008.002.02';
    ...
    protected function _generateXml() {
         ...
         * Document base
         */
        $this->_xml = simplexml_load_string('<?xml version="1.0" encoding="utf-8"?><Document xmlns="urn:iso:std:iso:20022:tech:xsd:'.$this->_painFormat.'" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"></Document>');
        ...
        $PaymentInformation->PmtTpInf->addChild('LclInstrm')->addChild('Cd', $this->_debitType); /* ISO: 2.11, 2.12 */
        $PaymentInformation->PmtTpInf->addChild('SeqTp', $this->_sequenceType); /* ISO: 2.14 */
     ...
     * @return Sepa_DirectDebit
     */
    public function setPainFormat($painFormat) {
        $this->_painFormat = $painFormat;
        return $this;
    }

    /**
     * Debit Type (CORE, COR1, B2B)
     *
     * @param $debitType
     * @return Sepa_DirectDebit
     */
